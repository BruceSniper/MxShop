# Generated by Django 2.2 on 2020-05-04 14:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, null=True, on_delete=None, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类目录')),
            ],
            options={
                'verbose_name': '商品类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('category', models.ForeignKey(null=True, on_delete=None, to='goods.GoodsCategory', verbose_name='品牌类目')),
            ],
            options={
                'verbose_name': '品牌',
        ...
        migrations.AddField(
            model_name='goods',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=None, to='goods.GoodsCategory', verbose_name='商品类目'),
        ),
        migrations.CreateModel(
            name='Banner',
            fields=[
